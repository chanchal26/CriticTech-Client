        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="mx-auto sm:text-center lg:max-w-2xl">
                <Pdf targetRef={ref} filename="code-example.pdf">
                    {({ toPdf }) => <button className="btn btn-wide mt-5" onClick={toPdf}>Download PDF</button>}
                </Pdf>


                <div className="mb-4 mt-10 transition-shadow duration-300 hover:shadow-xl lg:mb-6">
                    <img
                ...
                <div>
                    <Link to={`/price/${data.id}`} className='mr-4 mb-4'><button className="btn btn-wide">Get Premium Access</button></Link>
                </div>
            </div>
        </div>
    );
