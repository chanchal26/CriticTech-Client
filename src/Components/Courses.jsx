            ...
            <div className="relative px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
                <div className="relative mx-auto max-w-7xl">
                    <div className="grid max-w-lg gap-5 mx-auto lg:grid-cols-3 lg:max-w-none">
                        ...
                        <div className="flex flex-col overflow-hidden rounded-lg shadow-lg">
                            <div className="flex-shrink-0">
                                <img className="object-cover w-full h-48" src="https://images.unsplash.com/photo-1510166089176-b57564a542b1?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=2024&amp;q=80" alt="" />
                            </div>
                            <div className="flex flex-col justify-between flex-1 p-6 bg-white">
                                <div className="flex-1">
                                    <Link href="https://twitter.com/g_perales" className="block mt-2">
                                ...
                                <div className="flex items-center mt-6">
                                    <div className="flex-shrink-0">
                                        <Link href="https://twitter.com/g_perales">
                                    ...
                                    <div className="ml-3">
                                        <p className="text-sm font-medium text-neutral-600">
                                            <Link href="#" className="hover:underline"> Gabriel Perales </Link>
                                        </p>
                                        <div className="flex space-x-1 text-sm text-gray-500">
                        ...
                        <div className="flex flex-col overflow-hidden rounded-lg shadow-lg">
                            <div className="flex-shrink-0">
                                <img className="object-cover w-full h-48" src="https://images.unsplash.com/photo-1516245556508-7d60d4ff0f39?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDN8fHxlbnwwfHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=900&amp;q=60" alt="" />
                            </div>
                            <div className="flex flex-col justify-between flex-1 p-6 bg-white">
                                <div className="flex-1">
                                    <Link href="#" className="block mt-2">
                                ...
                                <div className="flex items-center mt-6">
                                    <div className="flex-shrink-0">
                                        <Link href="https://twitter.com/wickedlabsHQ">
                                    ...
                                    <div className="ml-3">
                                        <p className="text-sm font-medium text-neutral-600">
                                            <Link href="https://twitter.com/wickedlabsHQ" className="hover:underline"> Wicked Labs </Link>
                                        </p>
                                        <div className="flex space-x-1 text-sm text-gray-500">
